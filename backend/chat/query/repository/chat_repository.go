...
// Chat
//
//func (r *ChatReadModelRepository) SetChat(ctx context.Context, chatEvent *domain.ChatEvent) (*query.ChatReadModel, error) {
//	key := fmt.Sprintf(formatChatKey, chatEvent.)
...
//}
//
//func (r *ChatReadModelRepository) SetArgsChat(ctx context.Context, chatEvent *domain.ChatEvent) (*query.ChatReadModel, error) {
